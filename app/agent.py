...
class ProductionAgent:
    ...
    def __init__ (self):
        ...
        self.primary_llm= ChatGoogleGenerativeAI(model=settings.primary_model, temperature=0, timeout=30, max_retries=0,api_key=settings.gemini_api_key)
        self.fallback_llm= ChatGoogleGenerativeAI(model=settings.fallback_model, temperature=0, timeout=30, max_retries=0, api_key=settings.gemini_api_key)
    ...
    def _build_graph(self):
        ...
        def handle_error(state:AgentState)->dict:
            ...
            return {
                "messages":[
                    AIMessage(content="I'm sorry, I'm having trouble processing your request right now. Please try again in a moment")
                ],
